// app.js
// Mengatur halaman utama, input data, pencarian, tabel hasil, verifikasi admin, dan export CSV.
...
function renderPreview(item) {
  ...
  el("previewContent").innerHTML = `
    ...
    <p>Data berhasil disimpan. Langkah berikutnya dilakukan oleh <strong>admin</strong> pada halaman <strong>Hasil Rekomendasi</strong> untuk verifikasi manual.</p>
  `;
}
      ...
      <tr>
        ...
        <td>
          <div class="table-actions">
            ${Auth.isAdmin() ? `<button onclick="openManualVerification(${index})" class="btn btn-primary small-btn">Verifikasi Manual/Edit</button>` : `<span class="status warning">Menunggu Admin</span>`}
          </div>
        </td>
      </tr>
    `;
