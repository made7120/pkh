...
// Saat sidang, jelaskan bahwa petugas dapat input dan melihat hasil secara read-only, sedangkan admin memverifikasi.
...
const Auth = (() => {
  ...
  const roleLabels = {
    petugas: "Petugas Input & Lihat Hasil",
    admin: "Admin Verifikasi"
  };

  const roleAccess = {
    petugas: ["dashboard", "input", "result"],
